...
export const REGIME_BAND_TABLE = [
  { key:"tenYear", short:"10Y", label:"10Y Direction",
    ...
    cardSummary:{ bull:"Falling yields support stocks", bear:"Rising yields pressure stocks", neutral:"Yields give no clear signal" },
    ...
    explain:{ full:"10-Year U.S. Treasury Yield", shortTitle:"Long-term interest rates",
      what:[
        "The yield is the annual return offered by a ten-year U.S. Treasury bond at its current price.",
        "MacroDash does not vote on the level: a one-month change below −0.10 percentage points helps; above +0.15 hurts.",
        "Higher yields can pressure stock valuations, especially for businesses whose profits lie far ahead. This does not predict any individual stock’s return.",
      ] },
  ...
  { key:"vix", short:"VIX", label:"VIX Level",
    plain:"volatility",
    cardSummary:{ bull:"Low volatility supports stocks", bear:"High volatility signals caution", neutral:"Volatility gives no clear signal" },
    ...
    explain:{ full:"Cboe Volatility Index (VIX)", shortTitle:"Expected market swings",
      what:[
        "VIX uses S&P 500 option prices to estimate expected stock-market volatility over the next month.",
        "The teens are calm; around 20 is typical and 30 elevated. MacroDash’s separate bands: below 18 helps, above 25 hurts.",
        "VIX measures expected movement, not its direction. Calm conditions do not rule out losses, and a spike does not identify the bottom.",
      ] },
  ...
  { key:"fearGreed", short:"F&G", label:"Fear & Greed",
    plain:"sentiment",
    cardSummary:{ bull:"Optimistic sentiment supports stocks", bear:"Fearful sentiment signals caution", neutral:"Sentiment gives no clear signal" },
  ...
  { key:"cpiHeadline", short:"CPI", label:"CPI Trend",
    plain:"inflation",
    cardSummary:{ bull:"Cooling inflation supports stocks", bear:"Hot inflation pressures stocks", neutral:"Inflation gives no clear signal" },
    ...
    explain:{ full:"Consumer Price Index (CPI), year over year", shortTitle:"Consumer price inflation",
      what:[
        "CPI measures changes in prices paid by urban consumers. The displayed percentage compares prices with a year earlier.",
        "MacroDash judges the trend, not a single inflation level. The Fed’s 2% target is on PCE, not CPI.",
        "Persistent inflation can limit room for lower interest rates, affecting financing and valuations. A cooler report does not mean prices fell or guarantee a rate cut.",
      ] },
  ...
  { key:"valuation", short:"VAL", label:"Valuation",
    plain:"valuation",
    cardSummary:{ bull:"Valuations support the stock outlook", bear:"High valuations signal caution", neutral:"Valuations give no clear signal" },
    ...
    explain:{ full:"Cyclically Adjusted Price-to-Earnings ratio (Shiller CAPE)", shortTitle:"Market valuation",
      what:[
        "Shiller CAPE compares stock prices with ten years of inflation-adjusted earnings. A higher ratio means paying more for those past profits.",
        `Old average about ${CAPE_MEAN}; 1999 peak ${CAPE_ATH}. MacroDash: below ${(CAPE_MEAN * 1.5).toFixed(1)} helps; otherwise above 30 or 90% of the peak hurts.`,
        "CAPE describes broad-market valuation, not a company’s worth or an entry date. Expensive markets can keep rising; a lower multiple does not guarantee returns.",
      ] },
  ...
  { key:"nfci", short:"NFCI", label:"Fin Conditions",
    ...
    cardSummary:{ bull:"Looser financial conditions support stocks", bear:"Tighter financial conditions pressure stocks", neutral:"Financial conditions give no clear signal" },
    ...
    explain:{ full:"Chicago Fed National Financial Conditions Index (NFCI)", shortTitle:"Financial conditions",
      what:[
        "The Chicago Fed’s weekly index combines 105 measures of how easily money and credit flow through the financial system.",
        "Zero is average by construction; negative means looser, positive tighter. Conditions have run persistently below zero since 2008.",
        "Easier credit can support borrowing and investment. This is a financing backdrop, not evidence that a particular company is profitable or attractively priced.",
      ] },
