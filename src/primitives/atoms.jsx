...
export const Badge=({label,color,small})=>(
  <span style={{background:color+"22",color,border:`1px solid ${color}44`,borderRadius:3,padding:small?"0 4px":"1px 6px",fontSize:small?T.fsXs:T.fsS,fontFamily:T.fontMono,letterSpacing:"0.04em",whiteSpace:"nowrap"}}>{label}</span>
);
export const Label=({children,color})=>(
  <div style={{fontFamily:T.fontMono,fontSize:T.fsS,color:color||T.textMuted,letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:3}}>{children}</div>
);
