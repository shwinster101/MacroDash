...
export function testHeroFace(ok){
 ...
 const call={schema:"md-call-v1",status:"PUBLISHED",direction:"NEUTRAL"};
 ...
 for(const args of [{call,frozen:false},{call:{...call,status:"WITHHELD"},frozen:true},{call:{...call,direction:null},frozen:true},{}]){
